  ...
  <ion-page>
    ...
    <ion-content :fullscreen="true">
      <ion-header collapse="condense">
        ...
        <ion-item>
            <ion-input v-model="postalCode" label="Code postal" labelPlacement="floating" placeholder="60200" @input="searchByPostalCode"></ion-input>
        </ion-item>
        <ion-item>
            <ion-input v-model="cityName" label="Ville" labelPlacement="floating" placeholder="Compiègne" @input="searchByName"></ion-input>
        </ion-item>
